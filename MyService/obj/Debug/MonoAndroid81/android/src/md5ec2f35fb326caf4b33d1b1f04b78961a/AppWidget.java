...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MyService.AppWidget, MyService", AppWidget.class, __md_methods);
	}
	...
	public AppWidget ()
	{
		...
		if (getClass () == AppWidget.class)
			mono.android.TypeManager.Activate ("MyService.AppWidget, MyService", "", this, new java.lang.Object[] {  });
	}
