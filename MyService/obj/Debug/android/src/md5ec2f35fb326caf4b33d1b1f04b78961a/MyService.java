...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MyService.MyService, MyService", MyService.class, __md_methods);
	}
	...
	public MyService ()
	{
		...
		if (getClass () == MyService.class)
			mono.android.TypeManager.Activate ("MyService.MyService, MyService", "", this, new java.lang.Object[] {  });
	}
